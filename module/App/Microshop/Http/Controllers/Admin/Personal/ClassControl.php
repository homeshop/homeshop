<?php namespace App\Microshop\Http\Controllers\Admin\Personal;
    ...
    private function show_menu_personal_class($menu_key) {
        $menu_array = [
            'personal_class_list' => [
                ...
                'menu_url' => 'index.php?act=personal_class&op=personalclass_list'
            ],
            'personal_class_add' => [
                'menu_type' => 'link',
                'menu_name' => Language::get('nc_new'),
                'menu_url' => 'index.php?act=personal_class&op=personalclass_add'
            ],
        ];
        if($menu_key == 'personal_class_edit'){
            $menu_array['personal_class_edit'] = [
                'menu_type' => 'link',
