<?php namespace App\Cms\Http\Controllers\Admin\Cms\Article;
    ...
    private function show_menu($menu_key) {
        $menu_array = [
            'list' => [
                ...
                'menu_url' => 'index.php?act=cms_article_class&op=cms_article_class_list'
            ],
            'add' => [
                'menu_type' => 'link',
                'menu_name' => Language::get('nc_new'),
                'menu_url' => 'index.php?act=cms_article_class&op=cms_article_class_add'
            ],
        ];
