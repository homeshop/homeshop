...
class  HourControl extends BaseCronControl {
    ...
    private function _build_goods($goods_list = []) {
        ...
        //商品图
        $image_list = $model_goods->getGoodsImageList([
            'goods_commonid' => [
                'in',
                $goods_commonid_array
            ]
        ...
        foreach($goods_list as $k => $goods_info){
            if($goods_class[ $goods_info['gc_id'] ]['show_type'] == 1){
                ...
                foreach($image_list as $image_info){
                    if($goods_info['goods_commonid'] == $image_info['goods_commonid'] && $goods_info['store_id'] == $image_info['store_id'] && $goods_info['color_id'] == $image_info['color_id']){
                ...
                foreach($image_list as $image_info){
                    if($goods_info['goods_commonid'] == $image_info['goods_commonid'] && $goods_info['store_id'] == $image_info['store_id'] && $image_info['is_default'] == 1){
                        $goods_list[ $k ]['image'][] = $image_info['goods_image'];
                    }
                }
        ...
        $attr_list = $model_type->getGoodsAttrIndexList([
            'goods_id' => [
                'in',
                $goods_id_array
            ]
        ], 0, 'goods_id,attr_value_id');
