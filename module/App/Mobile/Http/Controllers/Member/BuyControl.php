...
class BuyControl extends MobileMemberControl {
    ...
    public function buy_step1Op() {
        ...
        if(intval($_POST['address_id']) > 0){
            $result['address_info'] = Model('address')->getDefaultAddressInfo([
        ...
        $buy_list['rpt_list'] = $result['rpt_list'] ? $result['rpt_list'] : [];
        ...
        $buy_list['rpt_info'] = $result['rpt_info'] ? $result['rpt_info'] : [];
    ...
    public function buy_step2Op() {
        ...
        output_data(['pay_sn' => $result['data']['pay_sn'], 'payment_code' => $order_info['payment_code']]);
    }
    ...
    public function payOp() {
        ...
        $pay['payment_list'] = $payment_list ? array_values($payment_list) : [];
        output_data(['pay_info' => $pay]);
    }
