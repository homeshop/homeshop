 ...
 * 商家订单
 */
class OrderControl extends MobileSellerControl {
    ...
    public function order_listOp() {
        ...
        $order_list = $model_order->getStoreOrderList($this->store_info['store_id'], $_POST['order_sn'], $_POST['buyer_name'], $_POST['state_type'], $_POST['query_start_date'], $_POST['query_end_date'], $_POST['skip_off'], '*', ['order_goods']);
        $page_count = $model_order->gettotalpage();
        output_data(['order_list' => $order_list], mobile_page($page_count));
    }
