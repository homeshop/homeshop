 ...
 * 手机端微信公众账号二维码设置
 */
class ConnectControl extends SystemControl {
    
    private $links = [
        ['url' => 'act=mb_connect&op=wx', 'text' => '微信登录'],
        ['url' => 'act=mb_connect&op=wap_wx', 'text' => 'WAP微信登录'],
        ['url' => 'act=mb_connect&op=qq', 'text' => 'QQ互联'],
        ['url' => 'act=mb_connect&op=sina', 'text' => '新浪微博']
    ];
