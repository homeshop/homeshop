 ...
 * 平台客服
 */
class  MallconsultControl extends BaseMemberControl {
    ...
    public function indexOp() {
        ...
        $consult_list = $model_mallconsult->getMallConsultList(['member_id' => $_SESSION['member_id']], '*', '10');
    ...
    public function mallconsult_infoOp() {
        ...
        // 咨询详细信息
        $consult_info = Model('mall_consult')->getMallConsultInfo([
            'mc_id' => $id,
    ...
    public function add_mallconsultOp() {
        // 咨询类型列表
        $type_list = Model('mall_consult_type')->getMallConsultTypeList([]);
        Tpl::output('type_list', $type_list);
        if($_GET['inajax']){
    ...
    public function save_mallconsultOp() {
        ...
        $obj_validate->validateparam = [
            ...
            ["input" => $_POST["consult_content"], "require" => "true", "message" => "请填写咨询内容"]
        ];
    ...
    public function del_mallconsultOp() {
        ...
        $result = Model('mall_consult')->delMallConsult(['mc_id' => $id, 'member_id' => $_SESSION['member_id']]);
        if($result){
    ...
    private function profile_menu($menu_key = '') {
        $menu_array = [
            1 => [
                ...
                'menu_name' => '平台客服咨询列表',
                'menu_url' => urlShop('member_mallconsult', 'index')
            ],
        ];
