 ...
 * 代金券
 */
class  InformControl extends BaseMemberControl {
    ...
    public function inform_infoOp() {
        ...
        Tpl::output('goods_info', $goods_info);
        // 投诉类型
        $subject_info = Model('inform_subject')->getInformSubject(['in_inform_subject_id' => $inform_info['inform_subject_id']]);
    ...
    private function drop_inform($inform_id, $inform_pics) {
        ...
        $model_inform->dropInform(['inform_id' => $inform_id]);
    }
    ...
    private function profile_menu($menu_key = '') {
        $menu_array = [
            1 => [
                'menu_key' => 'inform_list',
                'menu_name' => '违规举报',
                'menu_url' => 'index.php?act=member_inform&op=inform_list'
            ],
        ];
