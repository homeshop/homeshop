 ...
 * 买家退款
 */
class  RefundControl extends BaseMemberControl {
    ...
    public function viewOp() {
        ...
        $detail_array = $model_refund->getDetailInfo(['refund_id' => $refund['refund_id']]);
        ...
        switch($menu_type) {
            case 'member_order':
                $menu_array = [
                    ...
                    [
                        'menu_key' => 'buyer_vr_refund',
                        'menu_name' => '虚拟兑码退款',
                        'menu_url' => 'index.php?act=member_vr_refund'
                    ]
                ];
                break;
        }
