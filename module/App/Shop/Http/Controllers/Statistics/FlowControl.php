 ...
 * 行业分析
 */
class  FlowControl extends BaseSellerControl {
    ...
    public function storeflowOp() {
        ...
        $where['stattime'] = ['between', $searchtime_arr];
        $where['type'] = 'sum';
    ...
    public function goodsflowOp() {
        ...
        if($statlist_tmp){
            ...
            //查询相应商品
            $goods_list_tmp = $model->statByGoods([
                'goods_id' => [
                    'in',
                    $goodsid_arr
                ]
    ...
    private function profile_menu($menu_key = '') {
        $menu_array = [
            1 => [
                'menu_key' => 'storeflow',
                'menu_name' => '店铺总流量',
                'menu_url' => 'index.php?act=statistics_flow&op=storeflow'
            ],
            2 => [
                'menu_key' => 'goodsflow',
                'menu_name' => '商品流量排名',
                'menu_url' => 'index.php?act=statistics_flow&op=goodsflow'
            ]
        ];
