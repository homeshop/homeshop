 ...
 * 统计概述
 */
class  GoodsControl extends BaseSellerControl {
    ...
    public function __construct() {
        ...
        //处理搜索时间
        if(in_array($this->search_arr['op'], ['price', 'hotgoods'])){
    ...
    public function goodslistOp() {
        ...
        if(trim($_GET['search_gname'])){
            $where['goods_name'] = ['like', "%".trim($_GET['search_gname'])."%"];
        }
        //查询总条数
        ...
        //排序
        $orderby_arr = ['ordergoodsnum asc', 'ordergoodsnum desc', 'ordergamount asc', 'ordergamount desc'];
        ...
        $stat_ordergoods = $model->statByStatordergoods($where, $field, [
            5,
            $countnum
        ], 0, $this->search_arr['orderby'], 'goods_id');
    ...
    private function profile_menu($menu_key = '') {
        $menu_array = [
            1 => [
                'menu_key' => 'goodslist',
                'menu_name' => '商品详情',
                'menu_url' => 'index.php?act=statistics_goods&op=goodslist'
            ],
            2 => [
                'menu_key' => 'price',
                'menu_name' => '价格销量',
                'menu_url' => 'index.php?act=statistics_goods&op=price'
            ],
            3 => [
                'menu_key' => 'hotgoods',
                'menu_name' => '热卖商品',
                'menu_url' => 'index.php?act=statistics_goods&op=hotgoods'
            ],
        ];
