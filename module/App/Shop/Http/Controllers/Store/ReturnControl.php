 ...
 * 卖家退货
 */
class  ReturnControl extends BaseSellerControl {
    ...
    public function indexOp() {
        ...
        $keyword_type = ['order_sn', 'refund_sn', 'buyer_name'];
    ...
    public function editOp() {
        ...
        if(chksubmit()){
            ...
            if($state){
                ...
                $param['param'] = [
                    'refund_url' => urlShop('member_return', 'view', ['return_id' => $return['refund_id']]),
            ...
            case 'return':
                $menu_array = [
                    [
                        'menu_key' => '2',
                        'menu_name' => '售前退货',
                        'menu_url' => 'index.php?act=store_return&lock=2'
                    ],
                    ['menu_key' => '1', 'menu_name' => '售后退货', 'menu_url' => 'index.php?act=store_return&lock=1']
                ];
                break;
        }
