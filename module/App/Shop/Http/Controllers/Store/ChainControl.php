...
class  ChainControl extends BaseSellerControl {
    ...
    public function chain_listOp() {
        $chain_list = $this->model_chain->getChainList(['store_id' => $_SESSION['store_id']], '*', 10);
    ...
    public function chain_editOp() {
        ...
        $chain_info = $this->model_chain->getChainInfo([
            'chain_id' => $chain_id,
        ...
        if(chksubmit()){
            ...
            $result = $this->model_chain->editChain($update, [
                'chain_id' => $chain_id,
                'store_id' => $_SESSION['store_id']
            ]);
            if($result){
    ...
    public function chain_delOp() {
        ...
        $result = $this->model_chain->delChain([
            ...
            case 'chain_list':
                $menu_array = [
                    [
                        'menu_key' => 'chain_list',
                        'menu_name' => '门店列表',
                        'menu_url' => urlShop('store_chain', 'chain_list')
                    ]
                ];
                break;
            case 'chain_add':
                $menu_array = [
                    ...
                    [
                        'menu_key' => 'chain_add',
                        'menu_name' => '添加门店',
                        'menu_url' => urlShop('store_chain', 'chain_add')
                    ]
                ];
                break;
            case 'chain_edit':
                $menu_array = [
                    ...
                    [
                        'menu_key' => 'chain_edit',
                        'menu_name' => '编辑门店',
                        'menu_url' => urlShop('store_chain', 'chain_edit')
                    ]
                ];
                break;
        }
