<?php namespace App\Shop\Http\Controllers\Store\Vr;
            ...
            case 'list':
                $menu_array = [
                    [
                        ...
                        'menu_url' => 'index.php?act=store_vr_order'
                    ],
                    [
                        'menu_key' => 'state_new',
                        'menu_name' => Language::get('nc_member_path_wait_pay'),
                        'menu_url' => 'index.php?act=store_vr_order&op=index&state_type=state_new'
                    ],
                    [
                        'menu_key' => 'state_pay',
                        'menu_name' => '已付款',
                        'menu_url' => 'index.php?act=store_vr_order&op=index&state_type=state_pay'
                    ],
                    [
                        'menu_key' => 'state_success',
                        'menu_name' => Language::get('nc_member_path_finished'),
                        'menu_url' => 'index.php?act=store_vr_order&op=index&state_type=state_success'
                    ],
                    [
                        'menu_key' => 'state_cancel',
                        'menu_name' => Language::get('nc_member_path_canceled'),
                        'menu_url' => 'index.php?act=store_vr_order&op=index&state_type=state_cancel'
                    ],
                ];
                break;
            case 'exchange':
                $menu_array = [
                    ...
                    [
                        'menu_key' => 'exchange',
                        'menu_name' => '兑换码兑换',
                        'menu_url' => 'index.php?act=store_vr_order&op=exchange'
                    ],
                ];
                break;
        }
