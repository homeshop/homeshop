...
class  EvaluateControl extends BaseSellerControl {
    ...
    public function listOp() {
        ...
        if(!empty($_GET['goods_name'])){
            $condition['geval_goodsname'] = ['like', '%'.$_GET['goods_name'].'%'];
        }
        if(!empty($_GET['member_name'])){
            $condition['geval_frommembername'] = ['like', '%'.$_GET['member_name'].'%'];
        }
    ...
    public function explain_saveOp() {
        ...
        $update = ['geval_explain' => $geval_explain];
    ...
    public function explain_again_saveOp() {
        ...
        $update = ['geval_explain_again' => $geval_explain_again];
        $condition = ['geval_id' => $geval_id];
        $result = $model_evaluate_goods->editEvaluateGoods($update, $condition);
