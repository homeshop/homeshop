 ...
 * 商家入住
 */
class  JoinincControl extends BaseHomeControl {
        ...
        if(!empty($joinin_detail)){
            ...
            switch(intval($joinin_detail['joinin_state'])) {
                ...
                case STORE_JOIN_STATE_VERIFY_FAIL:
                    if(!in_array($_GET['op'], ['step1', 'step2', 'step3', 'step4'])){
    ...
    private function step2_save_valid($param) {
        ...
        $obj_validate->validateparam = [
            ...
            [
                ...
                "min" => "1",
                "max" => "500",
                "message" => "姓名不能为空且必须小于50个字"
            ],
            ["input" => $param['business_licence_number_elc'], "require" => "true", "message" => "身份证扫描件不能为空"],
        ];
