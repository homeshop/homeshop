 ...
 * 统计概述
 */
class  GeneralControl extends SystemControl {
    
    private $links = [
        ['url' => 'act=stat_general&op=general', 'lang' => 'stat_generalindex'],
        ['url' => 'act=stat_general&op=setting', 'lang' => 'stat_goodspricerange'],
        ['url' => 'act=stat_general&op=orderprange', 'lang' => 'stat_orderpricerange']
    ];
