 ...
 * 手机专享管理
 */
class  SoleControl extends SystemControl {
    ...
    public function goods_list_xmlOp() {
        ...
        foreach($goods_list as $val){
            $o = '<a class="btn red confirm-del-on-click" href="javascript:;" data-href="' . urlAdminShop('promotion_sole', 'del_goods', ['goods_id' => $val['goods_id']]) . '"><i class="fa fa-trash"></i>删除</a>';
            
            $o .= '<a class="btn green" target="_blank" href="' . urlShop('goods', 'index', ['goods_id' => $val['goods_id']]) . '"><i class="fa fa-list-alt"></i>查看</a>';
...
EOB;
    ...
    public function sole_quota_list_xmlOp() {
        ...
        foreach($list as $val){
            ...
            $i['operation'] = '<a class="btn green" href="' . urlAdminShop('promotion_sole', 'goods_list', ['store_id' => $val['store_id']]) . '"><i class="fa fa-list-alt"></i>查看商品</a>';
    ...
    public function del_goodsOp() {
        ...
        if($goodsIds){
            ...
            $rs = Model('p_sole')->delSoleGoods(['goods_id' => ['in', $goodsIds]]);
    ...
    public function sole_settingOp() {
        ...
        if(chksubmit()){
            ...
            $obj_validate->validateparam = [
                [
                    "input" => $_POST["promotion_sole_price"],
                    "require" => "true",
                    'validator' => 'Number',
                    "message" => '请填写手机专享套餐价格'
                ],
