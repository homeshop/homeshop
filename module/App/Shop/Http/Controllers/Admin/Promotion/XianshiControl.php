 ...
 * 限时折扣管理
 */
class  XianshiControl extends SystemControl {
    ...
    public function xianshi_list_xmlOp() {
        ...
        foreach($xianshi_list as $val){
            $o = '<a class="btn red confirm-on-click" href="javascript:;" data-href="' . urlAdminShop('promotion_xianshi', 'xianshi_del', [
            ...
            if($val['editable']){
                $o .= '<li><a class="confirm-on-click" href="javascript:;" data-href="' . urlAdminShop('promotion_xianshi', 'xianshi_cancel', [
                        'xianshi_id' => $val['xianshi_id'],
                    ]) . '">取消活动</a></li>';
            }
            
            $o .= '<li><a class="confirm-on-click" href="' . urlAdminShop('promotion_xianshi', 'xianshi_detail', [
                    'xianshi_id' => $val['xianshi_id'],
                ]) . '">活动详细</a></li>';
    ...
    public function xianshi_cancelOp() {
        ...
        $model_xianshi = Model('p_xianshi');
        $result = $model_xianshi->cancelXianshi(['xianshi_id' => $xianshi_id]);
        if($result){
