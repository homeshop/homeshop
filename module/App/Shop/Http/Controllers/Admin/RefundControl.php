...
class  RefundControl extends SystemControl {
    ...
    private $links = [
        ['url' => 'act=refund', 'text' => '待处理'],
        ['url' => 'act=refund&op=refund_all', 'text' => '所有记录'],
        ['url' => 'act=refund&op=reason', 'text' => '退款退货原因']
    ];
    ...
    public function editOp() {
        ...
        if(chksubmit()){
            ...
            if($state){
                ...
                $param['param'] = [
                    'refund_url' => urlShop('member_refund', 'view', ['refund_id' => $refund['refund_id']]),
    ...
    private function _get_condition($condition) {
        ...
        if(!in_array($_GET['qtype_time'], ['add_time', 'seller_time', 'admin_time'])){
