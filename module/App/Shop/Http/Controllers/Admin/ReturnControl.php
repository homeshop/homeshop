...
class  ReturnControl extends SystemControl {
    ...
    private $links = [
        ['url' => 'act=return&op=return_manage', 'text' => '待处理'],
        ['url' => 'act=return&op=return_all', 'text' => '所有记录']
    ];
    ...
    public function get_manage_xmlOp() {
        ...
        foreach($return_list as $k => $return_info){
            ...
            $list['goods_name'] = "<a class='open' title='{$return_info['goods_name']}' href='" . urlShop('goods', 'index', ['goods_id' => $return_info['goods_id']]) . "' target='blank'>{$return_info['goods_name']}</a>";
    ...
    public function editOp() {
        ...
        if(chksubmit()){
            ...
            if($state){
                ...
                $param['param'] = [
                    'refund_url' => urlShop('member_refund', 'view', ['return_id' => $return['refund_id']]),
