...
class  UploadControl extends SystemControl {
    ...
    private $links = [
        ['url' => 'act=upload&op=param', 'lang' => 'upload_param'],
        ['url' => 'act=upload&op=default_thumb', 'lang' => 'default_thumb'],
        ['url' => 'act=upload&op=font', 'lang' => 'font_set']
    ];
    ...
    public function paramOp() {
        if(chksubmit()){
            ...
            $result = $model_setting->updateSetting(['image_dir_type' => intval($_POST['image_dir_type'])]);
            if($result){
