<?php namespace App\Shop\Http\Controllers\Buy;

use App\Shop\Http\Controllers\BaseBuyControl;
 ...
 * 虚拟商品购买
 */
class  VirtualControl extends BaseBuyControl {
    ...
    public function payOp() {
        ...
        if(empty($order_info) || !in_array($order_info['order_state'], [ORDER_STATE_NEW, ORDER_STATE_PAY])){
