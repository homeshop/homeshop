...
class  SnapshotControl extends BaseHomeControl {
    ...
    public function indexOp() {
        ...
        $order_goods_info = $model_order->getOrderGoodsInfo(['rec_id' => $rec_id]);
        ...
        $order_info = $model_order->getOrderInfo(['order_id' => $order_goods_info['order_id']]);
        Tpl::output('order_info', $order_info);
        
        $store_info = Model('store')->getStoreInfo(['store_id' => $order_goods_info['store_id']]);
