...
class messageControl extends SystemControl {
    ...
    private $links = [
        ['url' => 'act=message&op=seller_tpl', 'lang' => 'seller_tpl'],
        ['url' => 'act=message&op=member_tpl', 'lang' => 'member_tpl'],
    ];
    ...
    public function seller_tplOp() {
        $mstpl_list = Model('store_msg_tpl')->getStoreMsgTplList([]);
    ...
    public function seller_tpl_editOp() {
        ...
        $this->links[] = ['url' => 'act=message&op=seller_tpl_edit', 'lang' => 'seller_tpl_edit'];
    ...
    public function member_tplOp() {
        $mmtpl_list = Model('member_msg_tpl')->getMemberMsgTplList([]);
    ...
    public function member_tpl_editOp() {
        ...
        $this->links[] = ['url' => 'act=message&op=member_tpl_edit', 'lang' => 'member_tpl_edit'];
