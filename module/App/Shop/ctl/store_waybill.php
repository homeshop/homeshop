...
class store_waybillControl extends BaseSellerControl {
    ...
    public function waybill_manageOp() {
        ...
        $store_extend_info = $model_store_extend->getStoreExtendInfo(['store_id' => $_SESSION['store_id']], 'express');
    ...
    public function waybill_settingOp() {
        ...
        $store_waybill_info = $model_store_waybill->getStoreWaybillInfo(['store_waybill_id' => $store_waybill_id]);
