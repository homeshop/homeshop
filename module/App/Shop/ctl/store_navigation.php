...
class store_navigationControl extends BaseSellerControl {
    ...
    public function navigation_listOp() {
        ...
        $navigation_list = $model_store_navigation->getStoreNavigationList(['sn_store_id' => $_SESSION['store_id']]);
    ...
    public function navigation_editOp() {
        ...
        $model_store_navigation = Model('store_navigation');
        $sn_info = $model_store_navigation->getStoreNavigationInfo(['sn_id' => $sn_id]);
    ...
    public function navigation_delOp() {
        ...
        if($sn_id > 0){
            $condition = ['sn_id' => $sn_id, 'sn_store_id' => $_SESSION['store_id']];
            $model_store_navigation = Model('store_navigation');
