...
class store_brandControl extends BaseSellerControl {
    ...
    public function brand_addOp() {
        ...
        $model_brand = Model('brand');
        if($_GET['brand_id'] != ''){
            $brand_array = $model_brand->getBrandInfo([
        ...
        if(chksubmit()){
            ...
            $obj_validate->validateparam = [
                [
                    ...
                    "require" => "true",
                    "message" => $lang['store_goods_brand_name_null']
                ],
        ...
        switch($menu_type) {
            case 'brand_list':
                $menu_array = [
                    1 => [
                        'menu_key' => 'brand_list',
                        'menu_name' => $lang['nc_member_path_brand_list'],
                        'menu_url' => 'index.php?act=store_brand&op=brand_list'
                    ]
                ];
                break;
        }
