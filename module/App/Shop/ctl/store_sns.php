...
class store_snsControl extends BaseSellerControl {
    ...
    public function image_uploadOp() {
        ...
        if($album_limit > 0){
            $album_count = $model_album->getCount(['store_id' => $_SESSION['store_id']]);
        ...
        $upload->set('allow_type', ['gif', 'jpg', 'jpeg', 'png']);
    ...
    public function store_sns_saveOp() {
        ...
        $obj_validate->validateparam = [
            [
                ...
                "max" => 140,
                "min" => 1,
                "message" => Language::get('store_sns_center_error')
            ],
            [
                "input" => $_POST["goods_url"],
                "require" => "false",
                "validator" => "url",
                "message" => Language::get('store_goods_index_goods_price_null')
            ],
        ];
        ...
        switch($_POST['type']) {
            ...
            case '10':
                ...
                $where = ['store_id' => $_SESSION['store_id'], 'goods_id' => ['in', $goods_id_array]];
    ...
    public function settingOp() {
        ...
        $sauto_info = $model_storesnssetting->getStoreSnsSettingInfo(['sauto_storeid' => $_SESSION['store_id']]);
    ...
    private function profile_menu($menu_key) {
        $menu_array = [
            1 => [
                'menu_key' => 'store_sns_add',
                'menu_name' => Language::get('store_sns_add'),
                'menu_url' => 'index.php?act=store_sns&op=add'
            ],
            2 => [
                'menu_key' => 'store_sns_setting',
                'menu_name' => Language::get('store_sns_setting'),
                'menu_url' => 'index.php?act=store_sns&op=setting'
            ],
            3 => [
                'menu_key' => 'store_sns_brower',
                'menu_name' => Language::get('store_sns_browse'),
                'menu_url' => urlShop('store_snshome', 'index', ['sid' => $_SESSION['store_id']]),
                'target' => '_blank'
            ]
        ];
