...
<div class="admincp-header">
  ...
  <div  id="foldSidebar" style="display: none"><i class="fa fa-outdent " title="展开/收起侧边导航"></i></div>
  <div class="admincp-name">
    <h2  style="font-size: 18px;line-height: 35px;"><b>Home</b>SHOP 好卖通</h2>
  </div>
...
<div class="admincp-container unfold">
  <div class="admincp-container-left">
    ...
    <!--
    <div class="about hide" title="关于系统" onclick="ajax_form('about', '', '<?php echo urlAdmin('aboutus');?>', 640);"><i class="fa fa-copyright"></i><span>HomeSHOP, Inc.</span></div>
  -->
  </div>
