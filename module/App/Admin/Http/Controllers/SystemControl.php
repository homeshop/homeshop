...
class  SystemControl  {
    ...
    protected final function getNav() {
        ...
        return [$top_nav, $left_nav, $map_nav, $quick_array];
    }
     ...
     */
    protected final function sublink($links = [], $actived = '', $file = 'index.php') {
        $linkstr = '';
    ...
    protected function jsonOutput($errorMessage = false) {
        ...
        $jsonFlag = C('debug') && version_compare(PHP_VERSION, '5.4.0') >= 0 ? JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE : 0;
