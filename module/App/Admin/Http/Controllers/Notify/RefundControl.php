<?php namespace App\Admin\Http\Controllers\Notify;
        ...
        if($verify_result){//验证成功
            ...
            if($success_num > 0 && substr($details[2], 0, 7) == 'SUCCESS'){
                ...
                if($_GET['refund'] == "vr"){
                    ...
                    $detail_info = $model_refund->getDetailInfo(['batch_no' => $batch_no]);//退款详细
                ...
                $model_refund->editDetail(['batch_no' => $batch_no], $detail_array);
                $result = "success";
